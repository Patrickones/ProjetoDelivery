...
public class ClienteDAO {
    ...
    public ArrayList<Cliente> listar() {
        ...
        Cursor cursor = banco.query("clientes", new String[]{"id", "nome", "cpf", "telefone", "endereco", "id_pedidos"}, null, null, null, null, null);
    ...
    public Cliente ler(int id) {
        Cliente model = new Cliente();
        Cursor cursor = banco.query("clientes", new String[]{"id", "nome", "cpf", "telefone", "endereco", "id_pedidos"}, "id = ?", new String[]{String.valueOf(id)}, null, null, null);
        while (cursor.moveToNext()) {
            model.setId(cursor.getInt(0));
            model.setNome(cursor.getString(1));
            model.setCpf(cursor.getString(2));
